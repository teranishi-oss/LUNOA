        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full">
          <div className="max-w-xl">
            <motion.h1
              ...
              className="font-mincho text-[40px] sm:text-[48px] md:text-[56px] leading-[1.35] text-ink-900 mb-6"
            >
              通わなくていい
              <br />
              身体をつくる。
            ...
            <motion.p
              ...
              className="font-mincho font-semibold text-[17px] tracking-[0.02em] text-gold-600 mb-6"
            >
              渋谷で根本から。自分のペースで卒業へ。
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[15px] leading-[2] text-ink-700 mb-10 max-w-md"
            >
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center rounded-pill bg-gradient-to-br from-gold-500 to-gold-600 text-white font-bold text-[14px] tracking-[0.03em] px-8 py-4 shadow-soft hover:from-gold-600 hover:to-gold-500 hover:-translate-y-0.5 transition-all duration-300"
              >
                無料カウンセリングを予約する
              </a>
              <p className="text-[12px] tracking-[0.03em] text-ink-500">
