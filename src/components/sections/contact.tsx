        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8 animate-appear delay-300">
            <div className="grid gap-6">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-4 p-6 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow animate-appear"
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 animate-appear delay-300">
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">ご希望のサービス</label>
                <select className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors">
                  <option>サービスを選択してください</option>
                  <option>小顔矯正</option>
                  <option>骨盤矯正</option>
                  <option>猫背矯正</option>
                  <option>O脚・X脚矯正</option>
                  <option>全身調整</option>
              ...
              <div>
                ...
                <textarea 
                  ...
                  placeholder="お体の状態やお悩み、ご希望などをお聞かせください。初回の方は、特に気になる症状や改善したい点をお書きください。"
                ></textarea>
              </div>
              ...
              <div className="text-center mt-6">
                ...
                <a 
                  ...
                  className="inline-block bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 text-center no-underline"
                >
