              ...
              <div className="text-center pb-4">
                {therapist.name === "郡山 京梧（こおりやま けいご）" ? (
                  <div className="w-32 h-32 mx-auto mb-4 shadow-lg rounded-full overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-r from-amber-400 to-yellow-500 flex items-center justify-center text-white text-4xl font-bold">
                      院
                    </div>
                  </div>
                ) : therapist.name === "宮川 竜太（みやがわ りゅうた）" ? (
                  <div className="w-32 h-32 mx-auto mb-4 shadow-lg rounded-full overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-r from-blue-400 to-indigo-500 flex items-center justify-center text-white text-4xl font-bold">
                      宮
                    </div>
                  </div>
                ) : therapist.name === "佐藤 まりな（さとう まりな）" ? (
                  <div className="w-32 h-32 mx-auto mb-4 shadow-lg rounded-full overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-r from-pink-400 to-rose-500 flex items-center justify-center text-white text-4xl font-bold">
                      佐
                    </div>
                  </div>
                ) : therapist.name === "鈴木 響（すずき きょう）" ? (
                  <div className="w-32 h-32 mx-auto mb-4 shadow-lg rounded-full overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-r from-purple-400 to-indigo-500 flex items-center justify-center text-white text-4xl font-bold">
                      鈴
                    </div>
                  </div>
                ) : therapist.name === "高梨 美優（たかなし みゆう）" ? (
                  <div className="w-32 h-32 mx-auto mb-4 shadow-lg rounded-full overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-r from-green-400 to-emerald-500 flex items-center justify-center text-white text-4xl font-bold">
                      高
                    </div>
                  </div>
                ) : (
